                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    <form:form action="/register" method="post" modelAttribute="newUser">
                                        <!--* First name and last name field with label, input paths and errors -->
                                        <div class="mb-3">
                                            <form:label class="form-label" path="firstName">First name:</form:label>
                                            <form:input class="form-control" path="firstName"></form:input>
                                            <form:errors class="form-text text-danger" path="firstName"></form:errors>
                                        </div>
                                        <div class="mb-3">
                                            <form:label class="form-label" path="lastName">Last name:</form:label>
                                            <form:input class="form-control" path="lastName"></form:input>
                                            <form:errors class="form-text text-danger" path="lastName"></form:errors>
                                        </div>
