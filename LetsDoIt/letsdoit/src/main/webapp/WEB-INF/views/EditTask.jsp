                                            ...
                                            <div class="mx-auto col-md-6"
                                                ...
                                                <form:form method="POST" action="/tasks/new" modelAttribute="task"
                                                    ...
                                                    <div class="form-group mt-2">
                                                        <label for="completionStatus">Ready to pdate your staus? Congrats.</label>
                                                        ...
                                                        <form:errors path="completionStatus" class="text-danger" />
                                                    </div>
                                                    ...
                                                    <!-- * Priority -->
                                                    <div class="form-group mt-2">
                                                        <label for="priority"> Have to change your priority? No problem.
                                                        </label>
                                                    ...
                                                    <!-- * Description -->
                                                    <div class="form-group mt-2">
                                                        <label for="taskDescription">Need to change any of the details? Go for it.</label>
                                                    ...
                                                    <div class="text-center mt-2">
                                                        <input type="submit" value="${sessionScope.user.firstName}, LetsUpdateIt &#x1f414;"
